...
from screen_airdrop.receiver.reporting.factory import create_report_collector
...
class BasePipeline(ABC):
    ...
    def __init__(self, protocol: str):
        ...
        self.report_collector: Optional[ReportCollectorProtocol] = None
    ...
    def _create_report_collector(
        ...
        *,
        ...
        """
        return create_report_collector(
